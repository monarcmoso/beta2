...
Billing.prototype = {
    initialize: function(form, addressUrl, saveUrl){
        ...
        this.onComplete = this.resetLoadWaiting.bindAsEventListener(this);
         ...
         var myLink = document.getElementById('billing:use_for_shipping_yes');
         myLink.click();
    },
    ...
    newAddress: function(isNew){
        if (isNew) {
            ...
            Element.hide('billing-address-form');
            
        } else {
            Element.hide('billing-new-address-form');
            Element.show('billing-address-form');
        }
    },
...
//            }
    ...
    nextStep: function(transport){
        ...
        /*
          var discountcode_status = $$('[name="discountcode_status"]')[0].value;
          
        
            if(discountcode_status==1){
                discountcode.save();
            } 
        */
