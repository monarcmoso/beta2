...
//        Mage::getSingleton('core/session')->setSomeSessionVar($data[0]['count']); 
    ...
    {
        $this->loadLayout();
		$this->getLayout()->getBlock('head')->setTitle($this->__('Thank you for using Samplestore.com'));
        $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel("singpost_login/profile");
        $data = $model->getProfile($customer_id);
        if ($data[0]['count'] == 0) {$this->_redirect('checkout/cart/'); }*/
