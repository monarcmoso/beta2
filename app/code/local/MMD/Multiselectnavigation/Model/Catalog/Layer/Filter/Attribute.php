<?php
class MMD_Multiselectnavigation_Model_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            $currentIds = Mage::app()->getRequest()->getParam($attribute->getAttributeCode());
            $tags = array(
