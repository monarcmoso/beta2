...
class AW_Points_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    /**
     *  Points added for checkout rules
     */
    const ITEM_RULES = 1;
    ...
    {   
        return Mage::getSingleton('core/session')->getFreePoints();
    ...
    public function getPointsPerItem($storeId = null)
    {
        return (int)Mage::getStoreConfig(self::ITEM_RULES, $storeId);
    }
    //===========================EARNING POINTS==============================
