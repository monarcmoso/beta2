...
class AW_Points_InvitationController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->getLayout()->getBlock('head')->setTitle($this->__('Referral Centre - Sample Store'));
        $this->renderLayout();
    }
	/** Custom method to get list**/
	public function listAction()
	{
		$this->loadLayout();
        $this->_initPage();
        $block = $this->getLayout()->getBlock('points.invitation.invites');
    ...
    {
        $invite = Mage::getModel('points/invitation')->validateSecureCode($this->getRequest()->getParam('invitation'));
