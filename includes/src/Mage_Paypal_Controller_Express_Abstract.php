...
abstract class Mage_Paypal_Controller_Express_Abstract extends Mage_Core_Controller_Front_Action
{
    ...
    public function startAction()
    {
        try {
            ...
            $this->_getCheckoutSession()->addError($this->__('Unable to start your checkout.'));
            Mage::logException($e);
        }
    ...
    public function cancelAction()
    {
        try {
            ...
            if ($order && $order->getId() && $order->getQuoteId() == $this->_getCheckoutSession()->getQuoteId()) {
                ...
                $this->_getCheckoutSession()->addSuccess($this->__('Your checkout has been cancelled.'));
            }
        } catch (Mage_Core_Exception $e) {
            $this->_getCheckoutSession()->addError($e->getMessage());
        } catch (Exception $e) {
    ...
    public function returnAction()
    {
        try {
            ...
            Mage::getSingleton('checkout/session')->addError($this->__('Unable to process your checkout approval.'));
            Mage::logException($e);
        }
        $this->_redirect('checkout/cart');
    }
