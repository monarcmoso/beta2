...
class Mage_Catalog_CategoryController extends Mage_Core_Controller_Front_Action
{
	...
	if($category->getId()==13){ $titlemessage = 'Redeem all the free samples now at Sample Store.'; }
	else if($category->getId()==10){ $titlemessage = 'All your favourite products on Sample Store.'; } 
	else if($category->getId()==43){ $titlemessage = ' Out of stock- Request to be notified when the samples are restocked.'; } 
	else{ $titlemessage = $title."- Redeem the free samples now at Sample Store.";  }
                $headBlock->setTitle($titlemessage );
            $this->renderLayout();
